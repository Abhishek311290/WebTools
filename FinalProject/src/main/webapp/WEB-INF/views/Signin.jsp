...
<html>
    ...
    <body>
        ...
        <h1>Welcome To The Online Portal Career Opportunity</h1>

        Please make your selection below
		<form:form method="POST" action="secured/action" commandName="Credentials"  >
      ...
      <input type="password" class="form-control" id="lPassword" name="lPassword" path="lPassword">
		 ...
		 <p hidden> Invalid Login Credentials</p>
